...
class color {
  ...
  public:
    ...
    std::string toHexa() {
        //std::string colorToString = "RED : "+to_string(ucRed)+" Green : "+to_string(ucRed)+" blue :"+ to_string(ucBlue);
        //return colorToString;
        std::string hexCode = "#";
        hexCode += decToHexa(ucRed);
        hexCode += decToHexa(ucGreen);
        hexCode += decToHexa(ucBlue);
        return hexCode;
    }
    ...
    // convert hex to rgb
    //https://lindevs.com/convert-hex-to-rgb-color-using-cpp/
